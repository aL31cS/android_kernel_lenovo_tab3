...
void  Hi545_Sensor_calc_wbdata(struct HI545_otp_struct *otp)
{
   kal_uint16 wbcheck = 0, 
	...
	wb_flag = Hi545_Sensor_OTP_read(0x1832);
    ...
    switch (wb_flag)
	{
		...
		wb_unit_rg_h = Hi545_Sensor_OTP_read(0x1833);
		wb_unit_rg_l = Hi545_Sensor_OTP_read(0x1834);
		wb_unit_bg_h = Hi545_Sensor_OTP_read(0x1835);
		wb_unit_bg_l = Hi545_Sensor_OTP_read(0x1836);
		wb_unit_gg_h = Hi545_Sensor_OTP_read(0x1837);
		wb_unit_gg_l = Hi545_Sensor_OTP_read(0x1838);
		wb_golden_rg_h = Hi545_Sensor_OTP_read(0x1839);
		wb_golden_rg_l = Hi545_Sensor_OTP_read(0x183a);
		wb_golden_bg_h = Hi545_Sensor_OTP_read(0x183b);
		wb_golden_bg_l = Hi545_Sensor_OTP_read(0x183c);
		wb_golden_gg_h = Hi545_Sensor_OTP_read(0x183d);
		wb_golden_gg_l = Hi545_Sensor_OTP_read(0x183e);
		wb_unit_r_h = Hi545_Sensor_OTP_read(0x183f);
		wb_unit_r_l = Hi545_Sensor_OTP_read(0x1840);
		wb_unit_b_h = Hi545_Sensor_OTP_read(0x1841);
		wb_unit_b_l = Hi545_Sensor_OTP_read(0x1842);
		wb_unit_gr_h = Hi545_Sensor_OTP_read(0x1843);
		wb_unit_gr_l = Hi545_Sensor_OTP_read(0x1844);
		wb_unit_gb_h = Hi545_Sensor_OTP_read(0x1845);
		wb_unit_gb_l = Hi545_Sensor_OTP_read(0x1846);
		wb_golden_r_h = Hi545_Sensor_OTP_read(0x1847);
		wb_golden_r_l = Hi545_Sensor_OTP_read(0x1848);
		wb_golden_b_h = Hi545_Sensor_OTP_read(0x1849);
		wb_golden_b_l = Hi545_Sensor_OTP_read(0x184a);
		wb_golden_gr_h = Hi545_Sensor_OTP_read(0x184b);
		wb_golden_gr_l = Hi545_Sensor_OTP_read(0x184c);
		wb_golden_gb_h = Hi545_Sensor_OTP_read(0x184d);
		wb_golden_gb_l = Hi545_Sensor_OTP_read(0x184e);
		wbcheck = Hi545_Sensor_OTP_read(0x184f);
    		break;
		case 0xd0:	//Group2 valid
		wb_unit_rg_h = Hi545_Sensor_OTP_read(0x1850);
		wb_unit_rg_l = Hi545_Sensor_OTP_read(0x1851);
		wb_unit_bg_h = Hi545_Sensor_OTP_read(0x1852);
		wb_unit_bg_l = Hi545_Sensor_OTP_read(0x1853);
		wb_unit_gg_h = Hi545_Sensor_OTP_read(0x1854);
		wb_unit_gg_l = Hi545_Sensor_OTP_read(0x1855);
		wb_golden_rg_h = Hi545_Sensor_OTP_read(0x1856);
		wb_golden_rg_l = Hi545_Sensor_OTP_read(0x1857);
		wb_golden_bg_h = Hi545_Sensor_OTP_read(0x1858);
		wb_golden_bg_l = Hi545_Sensor_OTP_read(0x1859);
		wb_golden_gg_h = Hi545_Sensor_OTP_read(0x185a);
		wb_golden_gg_l = Hi545_Sensor_OTP_read(0x185b);
		wb_unit_r_h = Hi545_Sensor_OTP_read(0x185c);
		wb_unit_r_l = Hi545_Sensor_OTP_read(0x185d);
		wb_unit_b_h = Hi545_Sensor_OTP_read(0x185e);
		wb_unit_b_l = Hi545_Sensor_OTP_read(0x185f);
		wb_unit_gr_h = Hi545_Sensor_OTP_read(0x1860);
		wb_unit_gr_l = Hi545_Sensor_OTP_read(0x1861);
		wb_unit_gb_h = Hi545_Sensor_OTP_read(0x1862);
		wb_unit_gb_l = Hi545_Sensor_OTP_read(0x1863);
		wb_golden_r_h = Hi545_Sensor_OTP_read(0x1864);
		wb_golden_r_l = Hi545_Sensor_OTP_read(0x1865);
		wb_golden_b_h = Hi545_Sensor_OTP_read(0x1866);
		wb_golden_b_l = Hi545_Sensor_OTP_read(0x1867);
		wb_golden_gr_h = Hi545_Sensor_OTP_read(0x1868);
		wb_golden_gr_l = Hi545_Sensor_OTP_read(0x1869);
		wb_golden_gb_h = Hi545_Sensor_OTP_read(0x186a);
		wb_golden_gb_l = Hi545_Sensor_OTP_read(0x186b);
		wbcheck = Hi545_Sensor_OTP_read(0x186c);
		break;
		case 0xf4:	//Group3 valid
		wb_unit_rg_h = Hi545_Sensor_OTP_read(0x186d);
		wb_unit_rg_l = Hi545_Sensor_OTP_read(0x186e);
		wb_unit_bg_h = Hi545_Sensor_OTP_read(0x186f);
		wb_unit_bg_l = Hi545_Sensor_OTP_read(0x1870);
		wb_unit_gg_h = Hi545_Sensor_OTP_read(0x1871);
		wb_unit_gg_l = Hi545_Sensor_OTP_read(0x1872);
		wb_golden_rg_h = Hi545_Sensor_OTP_read(0x1873);
		wb_golden_rg_l = Hi545_Sensor_OTP_read(0x1874);
		wb_golden_bg_h = Hi545_Sensor_OTP_read(0x1875);
		wb_golden_bg_l = Hi545_Sensor_OTP_read(0x1876);
		wb_golden_gg_h = Hi545_Sensor_OTP_read(0x1877);
		wb_golden_gg_l = Hi545_Sensor_OTP_read(0x1878);
		wb_unit_r_h = Hi545_Sensor_OTP_read(0x1879);
		wb_unit_r_l = Hi545_Sensor_OTP_read(0x187a);
		wb_unit_b_h = Hi545_Sensor_OTP_read(0x187b);
		wb_unit_b_l = Hi545_Sensor_OTP_read(0x187c);
		wb_unit_gr_h = Hi545_Sensor_OTP_read(0x187d);
		wb_unit_gr_l = Hi545_Sensor_OTP_read(0x187e);
		wb_unit_gb_h = Hi545_Sensor_OTP_read(0x187f);
		wb_unit_gb_l = Hi545_Sensor_OTP_read(0x1880);
		wb_golden_r_h = Hi545_Sensor_OTP_read(0x1881);
		wb_golden_r_l = Hi545_Sensor_OTP_read(0x1882);
		wb_golden_b_h = Hi545_Sensor_OTP_read(0x1883);
		wb_golden_b_l = Hi545_Sensor_OTP_read(0x1884);
		wb_golden_gr_h = Hi545_Sensor_OTP_read(0x1885);
		wb_golden_gr_l = Hi545_Sensor_OTP_read(0x1886);
		wb_golden_gb_h = Hi545_Sensor_OTP_read(0x1887);
		wb_golden_gb_l = Hi545_Sensor_OTP_read(0x1888);
		wbcheck = Hi545_Sensor_OTP_read(0x1889);
		break;
		default:
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	s_DEVINFO_ccm->device_module = "L545A00";//can change if got module id
	s_DEVINFO_ccm->device_vendor = "Ofilm";
	s_DEVINFO_ccm->device_ic = "HI545";
	s_DEVINFO_ccm->device_version = "HIMAX";
	s_DEVINFO_ccm->device_info = "500W";
#endif
	#ifdef HI545_USE_AWB_OTP
		Hi545_Otp_Initial_Setting();
		Hi545OTPSetting();
		mid = Hi545_Sensor_Get_OTP_Mid();
		//Hi545_Sensor_calc_wbdata(&current_otp);
	#endif
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if ((*sensor_id == imgsensor_info.sensor_id)&&(mid == 7)) {
                LOG_INF("Ofilm i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
