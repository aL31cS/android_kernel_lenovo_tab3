...
#include "ov2680kdmipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "OV2680kd_camera_sensor"
#define LOG_1 LOG_INF("OV2680KD,MIPI 1LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = 0x2681, //OV2680MIPI_SENSOR_ID,  /*sensor_id = 0x2680*/ //record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	...
	s_DEVINFO_ccm->device_ic = "OV2680KD";
	s_DEVINFO_ccm->device_version = "OV";
...
UINT32 OV2680KDMIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
