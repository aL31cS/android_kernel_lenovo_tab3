...
#include "hi545qtmipi_Sensor.h"

extern void kdSetI2CSpeed(u32 i2cSpeed);  

/****************************Modify Following Strings for Debug****************************/
#define DEBUG_TAG   "[V28]"
#define PFX "[HI545QT]"DEBUG_TAG
#define LOG_1 LOG_INF("HI545QT,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = HI545QTMIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
/////////////////////////////////////////////////////////////////////////////////////////
#define HI545QT_USE_AWB_OTP
#ifdef HI545QT_USE_AWB_OTP
static void Hi545qt_bytewrite_cmos_sensor(kal_uint32 addr, kal_uint32 para)
{
...
static struct HI545QT_otp_struct current_otp = {0};

void Hi545qt_Otp_Initial_Setting(void)
{
	LOG_INF("Hi545qtOTPSetting begin:\n ");
...
void Hi545qtOTPSetting(void)
{	
	Hi545qt_bytewrite_cmos_sensor(0x0118, 0x00); //sleep On
	mDELAY(10);
	Hi545qt_bytewrite_cmos_sensor(0x0F02, 0x00); //pll disable
	Hi545qt_bytewrite_cmos_sensor(0x011A, 0x01); //CP TRI_H
	Hi545qt_bytewrite_cmos_sensor(0x011B, 0x09); //IPGM TRIM_H
	Hi545qt_bytewrite_cmos_sensor(0x0D04, 0x01); //Fsync Output enable
	Hi545qt_bytewrite_cmos_sensor(0x0D00, 0x07); //Fsync Output Drivability
	Hi545qt_bytewrite_cmos_sensor(0x004C, 0x01); //TG MCU enable
	Hi545qt_bytewrite_cmos_sensor(0x003E, 0x01); //OTP R/W
	Hi545qt_bytewrite_cmos_sensor(0x0118, 0x01); //sleep off
	//mDELAY(10);
	//Hi545qt_bytewrite_cmos_sensor(0x004C, 0x00); //TG MCU disable
	//Hi545qt_bytewrite_cmos_sensor(0x004C, 0x01); //TG MCU enable
	mDELAY(10);
	LOG_INF("Hi545qtOTPSetting exit :\n ");
}

kal_uint16 Hi545qt_Sensor_OTP_read(kal_uint16 otp_addr)
{
    kal_uint16 data;	
    Hi545qt_bytewrite_cmos_sensor(0x010a, (otp_addr & 0xff00)>> 8); //start address H        
    Hi545qt_bytewrite_cmos_sensor(0x010b, otp_addr& 0x00ff); //start address L
    Hi545qt_bytewrite_cmos_sensor(0x0102, 0x00); //single read
    	mDELAY(10);
    data = read_cmos_sensor(0x0108); //OTP data read  
	return data;
}

static kal_uint16 Hi545qt_Sensor_Get_OTP_Mid(void)
{
	kal_uint16 ModuleHouseID = 0,info_flag = 0; 
	info_flag = Hi545qt_Sensor_OTP_read(0x1801);
	LOG_INF("info_flag = 0x%x\n",info_flag);
    switch (info_flag)
	{	
		case 0x40:
			ModuleHouseID = Hi545qt_Sensor_OTP_read(0x1802);
    			break;
			
		case 0xd0:
			ModuleHouseID = Hi545qt_Sensor_OTP_read(0x1812);
			break;
		
		case 0xf4:
			ModuleHouseID = Hi545qt_Sensor_OTP_read(0x1822);
			break;
		
		default:		
			LOG_INF("Hi545qt_Sensor: info_flag error value: %d \n ",info_flag);
			break;
	}
...
void Hi545qt_Sensor_update_wb_gain(struct HI545QT_otp_struct *otp)
{
    kal_uint16 rg,bg;

    Hi545qt_bytewrite_cmos_sensor(0x0118, 0x00); //sleep On
    Hi545qt_bytewrite_cmos_sensor(0x003e, 0x00); //OTP mode off
    Hi545qt_bytewrite_cmos_sensor(0x0118, 0x01); //sleep Off
   ...
   LOG_INF("rg = 0x%x, bg = 0x%x\n", rg, bg);
    ...
    Hi545qt_bytewrite_cmos_sensor(0x050c, (rg & 0xff00) >> 8); //r_gain
    Hi545qt_bytewrite_cmos_sensor(0x050d, rg & 0x00ff); //r_gain
    Hi545qt_bytewrite_cmos_sensor(0x050e, (bg & 0xff00) >> 8); //b_gain
    Hi545qt_bytewrite_cmos_sensor(0x050f, bg & 0x00ff); //b_gain

   LOG_INF("Hi545qt Sensor update wb gain finished!!!\n");
}

void  Hi545qt_Sensor_calc_wbdata(struct HI545QT_otp_struct *otp)
{
   kal_uint16 wbcheck = 0, 
    ...
    kal_uint16 rg_golden_value = 0, 
			 bg_golden_value = 0, 
			 rg_value = 0, 
			 bg_value = 0;

	wb_flag = Hi545qt_Sensor_OTP_read(0x1832);
    ...
    switch (wb_flag)
	{
		...
		wb_unit_rg_h = Hi545qt_Sensor_OTP_read(0x1833);
		wb_unit_rg_l = Hi545qt_Sensor_OTP_read(0x1834);
		wb_unit_bg_h = Hi545qt_Sensor_OTP_read(0x1835);
		wb_unit_bg_l = Hi545qt_Sensor_OTP_read(0x1836);
		wb_unit_gg_h = Hi545qt_Sensor_OTP_read(0x1837);
		wb_unit_gg_l = Hi545qt_Sensor_OTP_read(0x1838);
		wb_golden_rg_h = Hi545qt_Sensor_OTP_read(0x1839);
		wb_golden_rg_l = Hi545qt_Sensor_OTP_read(0x183a);
		wb_golden_bg_h = Hi545qt_Sensor_OTP_read(0x183b);
		wb_golden_bg_l = Hi545qt_Sensor_OTP_read(0x183c);
		wb_golden_gg_h = Hi545qt_Sensor_OTP_read(0x183d);
		wb_golden_gg_l = Hi545qt_Sensor_OTP_read(0x183e);
		wb_unit_r_h = Hi545qt_Sensor_OTP_read(0x183f);
		wb_unit_r_l = Hi545qt_Sensor_OTP_read(0x1840);
		wb_unit_b_h = Hi545qt_Sensor_OTP_read(0x1841);
		wb_unit_b_l = Hi545qt_Sensor_OTP_read(0x1842);
		wb_unit_gr_h = Hi545qt_Sensor_OTP_read(0x1843);
		wb_unit_gr_l = Hi545qt_Sensor_OTP_read(0x1844);
		wb_unit_gb_h = Hi545qt_Sensor_OTP_read(0x1845);
		wb_unit_gb_l = Hi545qt_Sensor_OTP_read(0x1846);
		wb_golden_r_h = Hi545qt_Sensor_OTP_read(0x1847);
		wb_golden_r_l = Hi545qt_Sensor_OTP_read(0x1848);
		wb_golden_b_h = Hi545qt_Sensor_OTP_read(0x1849);
		wb_golden_b_l = Hi545qt_Sensor_OTP_read(0x184a);
		wb_golden_gr_h = Hi545qt_Sensor_OTP_read(0x184b);
		wb_golden_gr_l = Hi545qt_Sensor_OTP_read(0x184c);
		wb_golden_gb_h = Hi545qt_Sensor_OTP_read(0x184d);
		wb_golden_gb_l = Hi545qt_Sensor_OTP_read(0x184e);
		wbcheck = Hi545qt_Sensor_OTP_read(0x184f);
    		break;
		case 0xd0:	//Group2 valid
		wb_unit_rg_h = Hi545qt_Sensor_OTP_read(0x1850);
		wb_unit_rg_l = Hi545qt_Sensor_OTP_read(0x1851);
		wb_unit_bg_h = Hi545qt_Sensor_OTP_read(0x1852);
		wb_unit_bg_l = Hi545qt_Sensor_OTP_read(0x1853);
		wb_unit_gg_h = Hi545qt_Sensor_OTP_read(0x1854);
		wb_unit_gg_l = Hi545qt_Sensor_OTP_read(0x1855);
		wb_golden_rg_h = Hi545qt_Sensor_OTP_read(0x1856);
		wb_golden_rg_l = Hi545qt_Sensor_OTP_read(0x1857);
		wb_golden_bg_h = Hi545qt_Sensor_OTP_read(0x1858);
		wb_golden_bg_l = Hi545qt_Sensor_OTP_read(0x1859);
		wb_golden_gg_h = Hi545qt_Sensor_OTP_read(0x185a);
		wb_golden_gg_l = Hi545qt_Sensor_OTP_read(0x185b);
		wb_unit_r_h = Hi545qt_Sensor_OTP_read(0x185c);
		wb_unit_r_l = Hi545qt_Sensor_OTP_read(0x185d);
		wb_unit_b_h = Hi545qt_Sensor_OTP_read(0x185e);
		wb_unit_b_l = Hi545qt_Sensor_OTP_read(0x185f);
		wb_unit_gr_h = Hi545qt_Sensor_OTP_read(0x1860);
		wb_unit_gr_l = Hi545qt_Sensor_OTP_read(0x1861);
		wb_unit_gb_h = Hi545qt_Sensor_OTP_read(0x1862);
		wb_unit_gb_l = Hi545qt_Sensor_OTP_read(0x1863);
		wb_golden_r_h = Hi545qt_Sensor_OTP_read(0x1864);
		wb_golden_r_l = Hi545qt_Sensor_OTP_read(0x1865);
		wb_golden_b_h = Hi545qt_Sensor_OTP_read(0x1866);
		wb_golden_b_l = Hi545qt_Sensor_OTP_read(0x1867);
		wb_golden_gr_h = Hi545qt_Sensor_OTP_read(0x1868);
		wb_golden_gr_l = Hi545qt_Sensor_OTP_read(0x1869);
		wb_golden_gb_h = Hi545qt_Sensor_OTP_read(0x186a);
		wb_golden_gb_l = Hi545qt_Sensor_OTP_read(0x186b);
		wbcheck = Hi545qt_Sensor_OTP_read(0x186c);
		break;
		case 0xf4:	//Group3 valid
		wb_unit_rg_h = Hi545qt_Sensor_OTP_read(0x186d);
		wb_unit_rg_l = Hi545qt_Sensor_OTP_read(0x186e);
		wb_unit_bg_h = Hi545qt_Sensor_OTP_read(0x186f);
		wb_unit_bg_l = Hi545qt_Sensor_OTP_read(0x1870);
		wb_unit_gg_h = Hi545qt_Sensor_OTP_read(0x1871);
		wb_unit_gg_l = Hi545qt_Sensor_OTP_read(0x1872);
		wb_golden_rg_h = Hi545qt_Sensor_OTP_read(0x1873);
		wb_golden_rg_l = Hi545qt_Sensor_OTP_read(0x1874);
		wb_golden_bg_h = Hi545qt_Sensor_OTP_read(0x1875);
		wb_golden_bg_l = Hi545qt_Sensor_OTP_read(0x1876);
		wb_golden_gg_h = Hi545qt_Sensor_OTP_read(0x1877);
		wb_golden_gg_l = Hi545qt_Sensor_OTP_read(0x1878);
		wb_unit_r_h = Hi545qt_Sensor_OTP_read(0x1879);
		wb_unit_r_l = Hi545qt_Sensor_OTP_read(0x187a);
		wb_unit_b_h = Hi545qt_Sensor_OTP_read(0x187b);
		wb_unit_b_l = Hi545qt_Sensor_OTP_read(0x187c);
		wb_unit_gr_h = Hi545qt_Sensor_OTP_read(0x187d);
		wb_unit_gr_l = Hi545qt_Sensor_OTP_read(0x187e);
		wb_unit_gb_h = Hi545qt_Sensor_OTP_read(0x187f);
		wb_unit_gb_l = Hi545qt_Sensor_OTP_read(0x1880);
		wb_golden_r_h = Hi545qt_Sensor_OTP_read(0x1881);
		wb_golden_r_l = Hi545qt_Sensor_OTP_read(0x1882);
		wb_golden_b_h = Hi545qt_Sensor_OTP_read(0x1883);
		wb_golden_b_l = Hi545qt_Sensor_OTP_read(0x1884);
		wb_golden_gr_h = Hi545qt_Sensor_OTP_read(0x1885);
		wb_golden_gr_l = Hi545qt_Sensor_OTP_read(0x1886);
		wb_golden_gb_h = Hi545qt_Sensor_OTP_read(0x1887);
		wb_golden_gb_l = Hi545qt_Sensor_OTP_read(0x1888);
		wbcheck = Hi545qt_Sensor_OTP_read(0x1889);
		break;
		default:
		LOG_INF("Hi545qt_Sensor: wb_flag error value: 0x%x\n ",wb_flag);
		break;	
	}
	...
	if (checksum == wbcheck)
		{
			LOG_INF("Hi545qt_Sensor: WB checksum PASS\n ");
			otp->awb_status = 1;
		}
	else
		{
			LOG_INF("Hi545qt_Sensor: WB checksum Fail\n ");
		}
    ...
    LOG_INF("Read from module: rg_value = 0x%x,bg_value = 0x%x,rg_golden_value = 0x%x, bg_golden_value = 0x%x\n",rg_value ,bg_value,rg_golden_value, bg_golden_value);
  ...
  //  b_gain = (0x100 * bg_golden_value) / bg_value;
	...
	otp->R_Gain = r_gain;
	otp->B_Gain = b_gain;
  //  Hi545qt_Sensor_update_wb_gain( r_gain, b_gain);
...
static void sensor_init(void)
{
	...
	#ifdef HI545QT_USE_AWB_OTP
	Hi545qtOTPSetting();
	Hi545qt_Sensor_calc_wbdata(&current_otp);
	if(current_otp.awb_status == 1)
		{
			Hi545qt_Sensor_update_wb_gain(&current_otp);
		}
	#endif
}    /*    sensor_init  */
    ...
    /*    preview_setting  */
{
	...
	if (currefps == 240) { //24fps for PIP
		...
		write_cmos_sensor(0x0A04, 0x0113); // from 0112 to 0113
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	s_DEVINFO_ccm->device_module = "FH545AB";//can change if got module id
	s_DEVINFO_ccm->device_vendor = "Q-Tech";
	s_DEVINFO_ccm->device_ic = "HI545QT";
	s_DEVINFO_ccm->device_version = "HIMAX";
	s_DEVINFO_ccm->device_info = "500W";
#endif
	#ifdef HI545QT_USE_AWB_OTP
		Hi545qt_Otp_Initial_Setting();
		Hi545qtOTPSetting();
		mid = Hi545qt_Sensor_Get_OTP_Mid();
		//Hi545qt_Sensor_calc_wbdata(&current_otp);
	#endif
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if ((*sensor_id == imgsensor_info.sensor_id)&&(mid == 6)) {
                LOG_INF("Q-tech i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
		...
		devinfo_check_add_device(s_DEVINFO_ccm);
            ...
            LOG_INF("Q-tech Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
...
UINT32 HI545QT_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    HI545QT_MIPI_RAW_SensorInit    */
