...
#ifdef CONFIG_MTK_LENS_AD5820QTAF_SUPPORT
extern void AD5820QTAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long AD5820QTAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int AD5820QTAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
